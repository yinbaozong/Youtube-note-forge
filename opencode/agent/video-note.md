---
description: Execute the optional youtube-transcript v4.0.1 OpenCode compatibility workflow. Never skip transcript-guided frame extraction; allow one note-only validation repair.
mode: primary
permission:
  read: allow
  edit: allow
